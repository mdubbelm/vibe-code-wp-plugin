...
- Add short comments explaining what each part does`,
    ...
    'tips-further-h3-editor': 'Open-source editor',
    'tips-further-editor-p': 'Don\'t want VS Code (Microsoft) or Cursor (account required)? Two open-source options:',
    'tips-further-editor-li1': '<a href="https://vscodium.com/" target="_blank" rel="noopener">VSCodium</a> — VS Code without Microsoft branding or telemetry. Same interface, same shortcuts, MIT license. Combine with <a href="https://www.continue.dev/" target="_blank" rel="noopener">Continue</a> or <a href="https://cline.bot/" target="_blank" rel="noopener">Cline</a> as an open-source AI extension — bring your own API key (Anthropic, OpenAI) or run a local model via <a href="https://ollama.com/" target="_blank" rel="noopener">Ollama</a>.',
    'tips-further-editor-li2': '<a href="https://voideditor.com/" target="_blank" rel="noopener">Void</a> — an open-source fork explicitly built as a Cursor alternative. Bring-your-own-key for AI, no account needed. Younger and less mature than VSCodium, but closer to the Cursor experience.',
...
- Voeg korte commentaren toe die uitleggen wat elk onderdeel doet`,
    ...
    'tips-further-h3-editor': 'Open-source editor',
    'tips-further-editor-p': 'Geen VS Code (Microsoft) of Cursor (account verplicht)? Twee open-source opties:',
    'tips-further-editor-li1': '<a href="https://vscodium.com/" target="_blank" rel="noopener">VSCodium</a> — VS Code zonder Microsoft-branding of telemetrie. Zelfde interface, zelfde sneltoetsen, MIT-licentie. Combineer met <a href="https://www.continue.dev/" target="_blank" rel="noopener">Continue</a> of <a href="https://cline.bot/" target="_blank" rel="noopener">Cline</a> als open-source AI-extensie — gebruik je eigen API-key (Anthropic, OpenAI) of een lokaal model via <a href="https://ollama.com/" target="_blank" rel="noopener">Ollama</a>.',
    'tips-further-editor-li2': '<a href="https://voideditor.com/" target="_blank" rel="noopener">Void</a> — een open-source fork die expliciet als Cursor-alternatief is gebouwd. Bring-your-own-key voor AI, geen account nodig. Jonger en minder volwassen dan VSCodium, maar dichter bij de Cursor-ervaring.',
